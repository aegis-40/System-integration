...
2. **Shutdown system #2 — Emergency Boron Injection System (EBIS)** (`ebis_actuation`, ESF E6). A **passive, diverse** borated-water system (~**3000 ppm**), **isolated and dormant in normal operation**, DAS-armed. **CONFIRMED essential (N10/N12, 2026-07-01):** because the boron-free core is too reactive cold for rods alone, EBIS is the **credited path to cold subcriticality and MSLB termination** — the required diverse shutdown system, not merely an ATWS backup. Diverse from #1 (chemical poison vs mechanical insertion → no shared insertion CCF, §6.8). **§6.10 met: EBIS ALONE holds cold-subcritical at the most-reactive state — k_adj 0.930 at 3000 ppm (N10).** SBF intact (boron dormant, no operational soluble boron).
