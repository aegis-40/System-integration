...
| C3 | **TES technology** — 🟡 **under team deliberation (2026-06-13)** | **Thermochemical** zeolite 13X sorption, ~390 t, charge ~280 °C/15 bar pass-out steam (§8.10.3, §8.10.2) | **Two-tank sensible Therminol-66** 265/268 °C (PFD: TK-C/TK-H, IHX E-2, discharge boiler E-3) | Direct contradiction with the PFD. Alisher's scope — team still deciding; FER §8.9 + §8.10 + PFD must say the same thing. **Gates the layout/CAD recut.** |
